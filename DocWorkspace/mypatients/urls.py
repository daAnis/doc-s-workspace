...
urlpatterns = [
    ...
    path('wards/<int:ward>/<int:record_id>/observation/temp/update/<str:temp_label>/', views.temp_update, name='temp_update'),
    path('wards/<int:ward>/<int:record_id>/observation/temp/delete/<str:temp_label>/', views.temp_delete, name='temp_delete'),
